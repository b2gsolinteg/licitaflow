...
def render_public_landing(logo_path: Path | str | None = None) -> None:
    ...
    .lnx-photo{{position:relative;z-index:2;width:88%;height:72%;min-height:520px;border-radius:72px;overflow:hidden;box-shadow:0 30px 80px rgba(4,15,48,.24);background:#E6EDF4}}
      ...
      <header class="lnx-top">
        <div class="lnx-top-inner">
          <a class="lnx-brand" href="#">
            <span class="lnx-mark"><svg viewBox="0 0 64 64" aria-hidden="true"><g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="7"><path d="M18 35l-4 4a13 13 0 0018 18l8-8a13 13 0 000-18" stroke="#F5B914"/><path d="M46 29l4-4A13 13 0 0032 7l-8 8a13 13 0 000 18" stroke="#2A74C9"/><path d="M25 39l14-14" stroke="#CFE3FF"/></g></svg></span>
