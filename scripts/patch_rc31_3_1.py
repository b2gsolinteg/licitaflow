...
RC313_TEST = Path("tests/test_rc31_3_ux.py")
...
rc313_test = RC313_TEST.read_text(encoding="utf-8")
old_assertion = 'self.assertIn(\'APP_VERSION = "1.0 Essential RC31.3"\', source)'
new_assertion = 'self.assertIn(\'APP_VERSION = "1.0 Essential RC31.3.1"\', source)'
if rc313_test.count(old_assertion) != 1:
    raise SystemExit("contrato de versão RC31.3 não encontrado exatamente uma vez")
RC313_TEST.write_text(rc313_test.replace(old_assertion, new_assertion, 1), encoding="utf-8")
